...
public class ApplicationProcessor extends AbstractProcessor {
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnvironment) {
        ...
        if (!roundEnvironment.getElementsAnnotatedWith(I18N.class).isEmpty()) {
            ...
            String[] dirtyLocales = roundEnvironment.getElementsAnnotatedWith(I18N.class)
                    .iterator()
                    .next()
            ...
            for (String locale : locales) {
                starter.append("   org.gwtproject.i18n.shared.cldr.impl.LocaleInfoFactory.holder.set(")
                        .append("\""+locale+"\"")
                        .append(", ")
                        .append("new org.gwtproject.i18n.shared.cldr.impl.LocaleInfoImpl_")
                        .append(locale).append("());").append(newLine);
            }


            starter.append(" }").append(newLine);
            starter.append("}").append(newLine);
            writeResource("org/gwtproject/i18n/shared/cldr/impl/LocaleInfoStarter.java", "org.gwtproject.i18n.shared.cldr.impl", starter.toString());
            writeResource("org/gwtproject/i18n/shared/cldr/impl/LocaleInfoStarter.native.js", "org.gwtproject.i18n.shared.cldr.impl", "LocaleInfoStarter.$create__();");
    ...
    private void copy(Filer filer, Set<String> locales) {
        ...
        Arrays.stream(impls).forEach(impl -> {
            holder.put(impl.getSimpleName(), new HashMap<>());
            for (String locale : locales) {
                URL url = findResource(filer, impl.getPackage().getName(), impl.getSimpleName().replaceAll("_", "") + "_" + locale + ".bak");
        ...
        for (String locale : locales) {
            URL url = findResource(filer, "org.gwtproject.i18n.shared.cldr.impl", "LocaleInfoImpl_" + locale + ".bak");
            ...
            try {
                ...
                new VoidVisitorAdapter<Object>() {
                    ...
                    public void visit(ClassOrInterfaceDeclaration comment, Object arg) {
                        ...
                        comment.getExtendedTypes().forEach(e -> {
                            if (!e.getName().asString().equals(LocaleInfoImpl.class.getCanonicalName())) {
