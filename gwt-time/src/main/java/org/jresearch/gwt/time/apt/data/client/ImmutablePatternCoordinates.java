 ...
 * {@code ImmutablePatternCoordinates.builder()}.
 * Use the static factory method to create immutable instances:
 * {@code ImmutablePatternCoordinates.of()}.
 */
@SuppressWarnings({"all"})
public final class ImmutablePatternCoordinates
        implements PatternCoordinates {
    ...
    private ImmutablePatternCoordinates(
            ImmutablePatternCoordinates original,
            Chrono chrono,
            Locale locale) {
        this.chrono = chrono;
        this.locale = locale;
    ...
    /**
     * Copy the current immutable object by setting a value for the {@link PatternCoordinates#chrono() chrono} attribute.
    ...
    /**
     * Copy the current immutable object by setting a value for the {@link PatternCoordinates#locale() locale} attribute.
    ...
    /**
     * This instance is equal to all instances of {@code ImmutablePatternCoordinates} that have equal attribute values.
    ...
    private boolean equalTo(ImmutablePatternCoordinates another) {
        return chrono.equals(another.chrono)
    ...
    /**
     * Creates an immutable copy of a {@link PatternCoordinates} value.
    ...
    public static ImmutablePatternCoordinates copyOf(PatternCoordinates instance) {
        ...
        return ImmutablePatternCoordinates.builder()
                .from(instance)
                .build();
    }
    ...
    public static final class Builder {
        ...
        private String formatRequiredAttributesMessage() {
            ...
            return "Cannot build PatternCoordinates, some of required attributes are not set " + attributes;
        }
    }
}
