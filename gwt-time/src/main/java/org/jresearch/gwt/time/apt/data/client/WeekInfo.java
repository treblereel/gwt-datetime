...
public class WeekInfo {
    ...
    static {
        ...
        FIRST_DAY.put(Integer.valueOf(6), EnumSet.of(AE, AF, BH, DJ, DZ, EG, IQ, IR, JO, KW, LY, OM, QA, SD, SY));
        FIRST_DAY.put(Integer.valueOf(7), EnumSet.of(AG, AS, AU, BD, BR, BS, BT, BW, BZ, CA, CN, CO, DM, DO, ET, GT, GU, HK, HN, ID, IL, IN, JM, JP, KE, KH, KR, LA, MH, MM, MO, MT, MX, MZ, NI, NP, PA, PE, PH, PK, PR, PT, PY, SA, SG, SV, TH, TT, TW, UM, US, VE, VI, WS, YE, ZA, ZW));
