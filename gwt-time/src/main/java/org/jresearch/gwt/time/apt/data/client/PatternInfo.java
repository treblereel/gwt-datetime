...
public class PatternInfo {
    ...
    static {
        ...
        DATE_TIME_FULL_PATTERNS.put("{1} 'jam' {0}", new PatternCoordinates[] {
                of(ISO, LocaleWrapper.forLanguageTag("su")),
        });
        DATE_TIME_FULL_PATTERNS.put("{1}{0}", new PatternCoordinates[] {
                of(ISO, LocaleWrapper.forLanguageTag("ff-Adlm")),
        ...
        DATE_TIME_FULL_PATTERNS.put("{1} तदा {0}", new PatternCoordinates[] {
                of(ISO, LocaleWrapper.forLanguageTag("sa")),
        });
        ...
        DATE_TIME_FULL_PATTERNS.put("{1} في {0}", new PatternCoordinates[] {
                of(ISO, LocaleWrapper.forLanguageTag("ar")),
        });
        DATE_TIME_FULL_PATTERNS.put("{1} 'fọ' {0}", new PatternCoordinates[] {
                of(ISO, LocaleWrapper.forLanguageTag("pcm")),
        });
        DATE_TIME_FULL_PATTERNS.put("{1} गी {0}", new PatternCoordinates[] {
                of(ISO, LocaleWrapper.forLanguageTag("doi")),
        });
        ...
        DATE_TIME_FULL_PATTERNS.put("{1}, 'во' {0}", new PatternCoordinates[] {
                of(ISO, LocaleWrapper.forLanguageTag("mk")),
        });
        DATE_TIME_FULL_PATTERNS.put("{1} 'a' 'les' {0}", new PatternCoordinates[] {
                of(THAI_BUDDHIST, LocaleWrapper.forLanguageTag("ast")),
        ...
        DATE_TIME_FULL_PATTERNS.put("{1} 'ɣef' {0}", new PatternCoordinates[] {
                of(ISO, LocaleWrapper.forLanguageTag("kab")),
        });
        ...
        DATE_TIME_LONG_PATTERNS.put("{1} 'jam' {0}", new PatternCoordinates[] {
                of(ISO, LocaleWrapper.forLanguageTag("su")),
        });
        DATE_TIME_LONG_PATTERNS.put("{1} 'sa' {0}", new PatternCoordinates[] {
                of(ISO, LocaleWrapper.forLanguageTag("ceb")),
        });
        DATE_TIME_LONG_PATTERNS.put("{1} तदा {0}", new PatternCoordinates[] {
                of(ISO, LocaleWrapper.forLanguageTag("sa")),
        });
        ...
        DATE_TIME_LONG_PATTERNS.put("{1} في {0}", new PatternCoordinates[] {
                of(ISO, LocaleWrapper.forLanguageTag("ar")),
        });
        DATE_TIME_LONG_PATTERNS.put("{1} 'fọ' {0}", new PatternCoordinates[] {
                of(ISO, LocaleWrapper.forLanguageTag("pcm")),
        });
        DATE_TIME_LONG_PATTERNS.put("{1} गी {0}", new PatternCoordinates[] {
                of(ISO, LocaleWrapper.forLanguageTag("doi")),
        });
        ...
        DATE_TIME_LONG_PATTERNS.put("{1}, 'во' {0}", new PatternCoordinates[] {
                of(ISO, LocaleWrapper.forLanguageTag("mk")),
        });
        DATE_TIME_LONG_PATTERNS.put("{1} 'a' 'les' {0}", new PatternCoordinates[] {
                of(THAI_BUDDHIST, LocaleWrapper.forLanguageTag("ast")),
        ...
        DATE_TIME_LONG_PATTERNS.put("{1} 'ɣef' {0}", new PatternCoordinates[] {
                of(ISO, LocaleWrapper.forLanguageTag("kab")),
        });
        ...
        DATE_TIME_MEDIUM_PATTERNS.put("{1}, 'во' {0}", new PatternCoordinates[] {
                of(ISO, LocaleWrapper.forLanguageTag("mk")),
        });
        DATE_TIME_MEDIUM_PATTERNS.put("{1}،‏ {0}", new PatternCoordinates[] {
                of(ISO, LocaleWrapper.forLanguageTag("fa")),
        ...
        DATE_TIME_SHORT_PATTERNS.put("{1}, 'во' {0}", new PatternCoordinates[] {
                of(ISO, LocaleWrapper.forLanguageTag("mk")),
        });
        DATE_TIME_SHORT_PATTERNS.put("{1}،‏ {0}", new PatternCoordinates[] {
                of(ISO, LocaleWrapper.forLanguageTag("fa")),
